...
database_vendas = pd.read_csv("Cafeteria Fictícia Receitas.csv")
...
database_compras = pd.read_csv("Cafeteria Fictícia Custos.csv") # database_estoques
...
database_balanco = pd.read_csv("Cafeteria Fictícia Balanço.csv", sep=';', decimal=',', thousands='.')
